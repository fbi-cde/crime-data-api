...
class TestOffenseByOffenseTypesEndpoint:
    ...
    def test_offenses_endpoint_with_just_state_year(self, testapp, swagger, variable):
    ...
    @pytest.mark.parametrize('variable', OffenseByOffenseTypeCountView.VARIABLES)
    def test_offenses_endpoint_with_postal_code(self, testapp, swagger, variable):
