...
class TestOffendersOffensesEndpoint:
    ...
    def test_state_endpoint_no_year_in_request_with_postal_code(self, swagger_beta, testapp):
    ...
    def test_victims_offenses_endpoint_with_just_state_year(self, testapp, swagger_beta, variable):
    ...
    def test_victims_offenses_endpoint_with_just_state_year_and_postal_code(self, testapp, swagger_beta):
    ...
    @pytest.mark.parametrize('variable', OffenseHateCrimeCountView.VARIABLES)
    def test_victims_offenses_endpoint_with_state_year_offense(self, testapp, swagger_beta, variable):
    ...
    def test_victims_offenses_endpoint_with_state_year_offense(self, testapp, swagger_beta, variable, explorer_offense):
