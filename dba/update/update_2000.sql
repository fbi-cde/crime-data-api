...
RETURN v_int_value;
END;
98602 LANGUAGE plpgsql;

CREATE OR REPLACE FUNCTION to_timestamp_ucr1(v_input text)
RETURNS timestamp without time zone AS 98602
...
RETURNS double precision AS 98602
...
\COPY ref_agency_county_temp (agency_id,county_id, metro_div_id, core_city_flag, data_year, population, census, legacy_county_code, legacy_msa_code, source_flag, change_timestamp, change_user) FROM '/Users/colincraig/crime-data-api/dba/update/REF_AC.csv' WITH DELIMITER '|';
...
-- insert into shell from csv.
\COPY ref_agency_covered_by_temp (agency_id,data_year, covered_by_agency_id) FROM '/Users/colincraig/crime-data-api/dba/update/REF_ACB.csv' WITH DELIMITER '|';
...
\COPY ref_county_temp (county_id, state_id, county_name, county_ansi_code, county_fips_code, legacy_county_code, comments) FROM '/Users/colincraig/crime-data-api/dba/update/REF_C.csv' WITH DELIMITER '|';
...
\COPY ref_country_temp (country_id, continent_id, country_desc) FROM '.csv' WITH DELIMITER '|';
...
\COPY ref_county_population_temp (county_id, data_year, population, source_flag, extra, change_timestamp, change_user, reporting_population) FROM '.csv' WITH DELIMITER '|';
...
\COPY ref_agency_population_temp (agency_id, data_year, population_group_id, population, source_flag, change_timestamp, change_user, city_sequence, suburban_area_flag) FROM '.csv' WITH DELIMITER '|';
...
\COPY ref_tribe_population_temp (tribe_id, data_year, population, source_flag, census, change_timestamp, change_user, reporting_population) FROM '.csv' WITH DELIMITER '|';
...
\COPY nibrs_incident_temp (agency_id, incident_id, nibrs_month_id, incident_number, cargo_theft_flag, submission_date, incident_date, report_date_flag, incident_hour, cleared_except_id, cleared_except_date, incident_status, data_home, ddocname, orig_format, ff_line_number, did) FROM '.csv' WITH DELIMITER ',';
...
\COPY nibrs_month_temp (nibrs_month_id, agency_id, month_num, data_year, reported_status, report_date, prepared_date, update_flag, orig_format, ff_line_number, data_home, ddocname, did) FROM '.csv' WITH DELIMITER ',';
...
\COPY nibrs_arrestee_weapon_temp (arrestee_id, weapon_id, nibrs_arrestee_weapon_id) FROM '.csv' WITH DELIMITER ',';
...
\COPY nibrs_bias_motivation_temp (bias_id, offense_id) FROM '.csv' WITH DELIMITER ',';
...
\COPY nibrs_criminal_act_temp (criminal_act_id, offense_id) FROM '.csv' WITH DELIMITER ',';
...
\COPY nibrs_offense_temp (offense_id, incident_id, offense_type_id, attempt_complete_flag, location_id, num_premises_entered, method_entry_code, ff_line_number) FROM '.csv' WITH DELIMITER ',';
...
\COPY nibrs_offender_temp (offender_id, incident_id, offender_seq_num, age_id, age_num, sex_code, race_id, ethnicity_id, ff_line_number, age_range_low_num, age_range_high_num) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_OF.csv' WITH DELIMITER ',';
...
\COPY nibrs_property_temp (property_id, incident_id, prop_loss_id, stolen_count, recovered_count, ff_line_number) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_P.csv' WITH DELIMITER ',';
...
\COPY nibrs_property_desc_temp (property_id, prop_desc_id, property_value, date_recovered, nibrs_prop_desc_id) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_PD.csv' WITH DELIMITER ',';
...
\COPY nibrs_suspected_drug_temp (suspected_drug_type_id, property_id, est_drug_qty, drug_measure_type_id, nibrs_suspected_drug_id) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_SD.csv' WITH DELIMITER ',';
...
\COPY nibrs_suspect_using_temp (suspect_using_id, offense_id) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_SU.csv' WITH DELIMITER ',';
...
\COPY nibrs_victim_temp (victim_id, incident_id, victim_seq_num, victim_type_id, assignment_type_id, activity_type_id, outside_agency_id, age_id, age_num, sex_code, race_id, ethnicity_id, resident_status_code, agency_data_year, ff_line_number, age_range_low_num, age_range_high_num) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_V.csv' WITH DELIMITER ',';
...
\COPY nibrs_victim_circumstances_temp (victim_id, circumstances_id, justifiable_force_id) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_VC.csv' WITH DELIMITER ',';
...
\COPY nibrs_victim_injury_temp (victim_id, injury_id) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_VI.csv' WITH DELIMITER ',';
...
\COPY nibrs_victim_offense_temp (victim_id, offense_id) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_VO.csv' WITH DELIMITER ',';
...
\COPY nibrs_victim_offender_rel_temp (victim_id, offender_id, relationship_id, nibrs_victim_offender_id) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_VOR.csv' WITH DELIMITER ',';
...
\COPY nibrs_weapon_temp (weapon_id, offense_id, nibrs_weapon_id) FROM '/Users/colincraig/crime-data-api/dba/update/NIBRS_W.csv' WITH DELIMITER ',';
...
\COPY reta_month_offense_subcat_temp (reta_month_id, offense_subcat_id, reported_count, reported_status, unfounded_count, unfounded_status, actual_count, actual_status, cleared_count, cleared_status, juvenile_cleared_count, juvenile_cleared_status) FROM '/Users/colincraig/crime-data-api/dba/update/RetAMOS.csv' WITH DELIMITER ',';
...
\COPY asr_month_temp (asr_month_id, agency_id, data_year, month_num, source_flag, reported_flag, orig_format, update_flag, ff_line_number, ddocname, did, data_home, extra) FROM '/Users/colincraig/crime-data-api/dba/update/ASRM.csv' WITH DELIMITER ',';
...
\COPY asr_race_offense_subcat_temp (asr_month_id , offense_subcat_id ,    race_id ,    juvenile_flag ,    arrest_count ,    arrest_status ,    active_flag ,    prepared_date ,    report_date ,    ff_line_number ,    asr_month_id_1,    agency_id,    data_year,    month_num,    source_flag,    reported_flag,    orig_format,    update_flag,    ff_line_number_1,    ddocname,    did,    data_home,    month_pub_status) FROM '/Users/colincraig/crime-data-api/dba/update/ASROS.csv' WITH DELIMITER ',';
...
\COPY asr_age_sex_subcat_temp (asr_month_id ,    offense_subcat_id ,    age_range_id ,    arrest_count ,    arrest_status ,    active_flag ,    prepared_date ,    report_date ,    ff_line_number ,    asr_month_id_1,    agency_id,    data_year,    month_num,    source_flag,    reported_flag,    orig_format,    update_flag,    ff_line_number_1,    ddocname,    did,    data_home,    month_pub_status) FROM '/Users/colincraig/crime-data-api/dba/update/ASRS.csv' WITH DELIMITER ',';
...
\COPY hc_quarter_temp (agency_id, quarter_num, data_year, reported_status, reported_count, hc_quarter_id, update_flag, orig_format, ff_line_number, ddocname, did, data_home, quarter_pub_status) FROM '/Users/colincraig/crime-data-api/dba/update/Hate_Q.csv' WITH DELIMITER ',';
...
\COPY hc_bias_motivation_temp (offense_id, bias_id) FROM '/Users/colincraig/crime-data-api/dba/update/Hate_BM.csv' WITH DELIMITER ',';
...
\COPY hc_offense_temp (offense_id, incident_id, offense_type_id, victim_count, location_id, nibrs_offense_id) FROM '/Users/colincraig/crime-data-api/dba/update/Hate_O.csv' WITH DELIMITER ',';
...
\COPY hc_victim_temp (offense_id, victim_type_id) FROM '/Users/colincraig/crime-data-api/dba/update/Hate_V.csv' WITH DELIMITER ',';
...
\COPY ct_victim_temp (incident_id, victim_type_id) FROM '/Users/colincraig/crime-data-api/dba/update/Cargo_V.csv' WITH DELIMITER ',';
...
\COPY ct_offense_temp (offense_id, incident_id, offense_type_id, location_id, ct_offense_flag) FROM '/Users/colincraig/crime-data-api/dba/update/Cargo_OO.csv' WITH DELIMITER ',';
...
\COPY ct_offender_temp (offender_id, incident_id, age, sex_code, ethnicity_id, race_id) FROM '/Users/colincraig/crime-data-api/dba/update/Cargo_O.csv' WITH DELIMITER ',';
...
\COPY ct_arrestee_temp (arrestee_id, incident_id, age, sex_code, ethnicity_id, race_id) FROM '/Users/colincraig/crime-data-api/dba/update/Cargo_A.csv' WITH DELIMITER ',';
...
\COPY ct_weapon_temp (incident_id, weapon_id, ct_weapon_id) FROM '/Users/colincraig/crime-data-api/dba/update/Cargo_W.csv' WITH DELIMITER ',';
...
\COPY ct_property_temp (property_id, prop_desc_id, incident_id, stolen_value, recovered_flag, date_recovered, recovered_value) FROM '/Users/colincraig/crime-data-api/dba/update/Cargo_P.csv' WITH DELIMITER ',';
...
\COPY arson_month_temp (arson_month_id, agency_id, data_year, month_num, data_home, source_flag, reported_flag, ddocname, month_included_in, report_date, prepared_date, orig_format, update_flag, did, ff_line_number, extra) FROM '.csv' WITH DELIMITER ',';
...
\COPY arson_month_by_subcat_temp (arson_month_id, subcategory_id, reported_count, reported_status, unfounded_count, unfounded_status, actual_count, actual_status, cleared_count, cleared_status, juvenile_cleared_count, juvenile_cleared_status, uninhabited_count, uninhabited_status, est_damage_value, est_damage_value_status) FROM '/Users/colincraig/crime-data-api/dba/update/ArsonMOS.csv' WITH DELIMITER ',';
...
-- !!!!!!!!!!!!!! Grep/Replace _2000 with the new _{YEAR} !!!!!!!!!!!!!!!
...
INSERT INTO nibrs_victim_denorm (incident_id, victim_id, year, incident_date) VALUES (9999999999,999999999, '2000',to_timestamp('01-01-2000','MM-DD-YYYY'));
DELETE from nibrs_victim_denorm_2000;
INSERT INTO nibrs_incident_denorm (incident_id, agency_id, year, incident_date) VALUES (9999999999,999999999, '2000',to_timestamp('01-01-2000','MM-DD-YYYY'));
DELETE from nibrs_incident_denorm_2000;
INSERT INTO nibrs_offender_denorm (incident_id, offender_id, year, incident_date)  VALUES (9999999999,999999999, '2000',to_timestamp('01-01-2000','MM-DD-YYYY'));
DELETE from nibrs_offender_denorm_2000;
INSERT INTO nibrs_offense_denorm (incident_id, offense_id, year, incident_date)  VALUES (9999999999,999999999, '2000',to_timestamp('01-01-2000','MM-DD-YYYY'));
DELETE from nibrs_offense_denorm_2000;
INSERT INTO nibrs_arrestee_denorm (incident_id, arrestee_id, year, incident_date)  VALUES (9999999999,999999999, '2000',to_timestamp('01-01-2000','MM-DD-YYYY'));
DELETE from nibrs_arrestee_denorm_2000;
INSERT INTO nibrs_property_denorm (incident_id, property_id, year, incident_date)  VALUES (9999999999,999999999, '2000',to_timestamp('01-01-2000','MM-DD-YYYY'));
DELETE from nibrs_property_denorm_2000;
...
INSERT INTO nibrs_incident_denorm_2000 (incident_id, agency_id, state_id, ori, year, incident_date) SELECT nibrs_incident_new.incident_id, nibrs_incident_new.agency_id, ref_agency.state_id, ref_agency.ori, EXTRACT(YEAR FROM nibrs_incident_new.incident_date) as year, nibrs_incident_new.incident_date from nibrs_incident_new JOIN ref_agency ON (ref_agency.agency_id = nibrs_incident_new.agency_id) where nibrs_incident_new.incident_date >= to_timestamp('01-01-2000', 'MM-DD-YYYY');
-- UPDATE nibrs_incident_denorm_2000 SET state_abbr = ref_state.state_postal_abbr from ref_state where nibrs_incident_denorm_2000.state_id = ref_state.state_id and nibrs_incident_denorm_2000.year = '2000';


-- Insert directly into a single partition to bypass the partition trigger (faster).
-- DONE (~5 min per update)
INSERT INTO nibrs_victim_denorm_2000 (incident_id, agency_id, year, incident_date, victim_id, age_id, age_num, sex_code, race_id, victim_type_id,resident_status_code) SELECT nibrs_victim_new.incident_id, nibrs_incident_new.agency_id, EXTRACT(YEAR FROM nibrs_incident_new.incident_date) as year, nibrs_incident_new.incident_date, nibrs_victim_new.victim_id, nibrs_victim_new.age_id, nibrs_victim_new.age_num::numeric, nibrs_victim_new.sex_code,nibrs_victim_new.race_id, nibrs_victim_new.victim_type_id, nibrs_victim_new.resident_status_code from nibrs_victim_new LEFT JOIN nibrs_incident_new on nibrs_incident_new.incident_id = nibrs_victim_new.incident_id where nibrs_incident_new.incident_date >= to_timestamp('01-01-2000', 'MM-DD-YYYY');
UPDATE nibrs_victim_denorm_2000 SET state_id = ref_agency.state_id, county_id = ref_agency_county.county_id from ref_agency JOIN ref_agency_county ON ref_agency.agency_id = ref_agency_county.agency_id where nibrs_victim_denorm_2000.agency_id = ref_agency.agency_id and nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET state_code = ref_state.state_code from ref_state where nibrs_victim_denorm_2000.state_id = ref_state.state_id and nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET race_code = ref_race.race_code from ref_race where nibrs_victim_denorm_2000.race_id = ref_race.race_id and nibrs_victim_denorm_2000.year = '2000'; 
UPDATE nibrs_victim_denorm_2000 SET offense_id = nibrs_offense_new.offense_id, offense_type_id = nibrs_offense_new.offense_type_id, location_id = nibrs_offense_new.location_id from nibrs_offense_new  where nibrs_offense_new.incident_id = nibrs_victim_denorm_2000.incident_id and nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET offense_name = nibrs_offense_type.offense_name from nibrs_offense_type where nibrs_offense_type.offense_type_id = nibrs_victim_denorm_2000.offense_type_id and nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET circumstance_name = nibrs_circumstances.circumstances_name, ethnicity = nibrs_ethnicity.ethnicity_name, victim_type = nibrs_victim_type.victim_type_name from nibrs_victim_circumstances ON nibrs_victim_circumstances.victim_id = nibrs_victim_denorm_2000.victim_id JOIN nibrs_circumstances ON nibrs_circumstances.circumstances_id = nibrs_victim_circumstances.circumstances_id JOIN nibrs_ethnicity ON nibrs_ethnicity.ethnicity_id = nibrs_victim_new.ethnicity_id JOIN nibrs_victim_type ON nibrs_victim_new.victim_type_id = nibrs_victim_type.victim_type_id where nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET location_name = nibrs_location_type.location_name, location_code=nibrs_location_type.location_code from nibrs_location_type where nibrs_location_type.location_id = nibrs_victim_denorm_2000.location_id and nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET property_id = nibrs_property_new.property_id, property_loss_id=nibrs_property_new.prop_loss_id from nibrs_property_new  where nibrs_property_new.incident_id = nibrs_victim_denorm_2000.incident_id and nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET property_desc_id = nibrs_property_desc_new.prop_desc_id from nibrs_property_desc_new where nibrs_property_desc_new.property_id = nibrs_victim_denorm_2000.property_id and nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET prop_desc_name = nibrs_prop_desc_type.prop_desc_name from nibrs_prop_desc_type where nibrs_prop_desc_type.prop_desc_id = nibrs_victim_denorm_2000.property_desc_id and nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET bias_id = nibrs_bias_motivation.bias_id from nibrs_bias_motivation where nibrs_bias_motivation.offense_id = nibrs_victim_denorm_2000.offense_id and nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET bias_name = nibrs_bias_list.bias_name from nibrs_bias_list where nibrs_victim_denorm_2000.bias_id = nibrs_bias_list.bias_id and nibrs_victim_denorm_2000.year = '2000';
UPDATE nibrs_victim_denorm_2000 SET offender_relationship = nibrs_relationship.relationship_name from nibrs_victim_offender_rel JOIN nibrs_relationship ON nibrs_relationship.relationship_id = nibrs_victim_offender_rel.relationship_id where nibrs_victim_denorm_2000.victim_id = nibrs_victim_offender_rel.victim_id and nibrs_victim_denorm_2000.year = '2000';


-- denorm offender
INSERT INTO nibrs_offender_denorm_2000 (incident_id, agency_id, year, incident_date, offender_id, age_id, age_num, sex_code, race_id, ethnicity) SELECT nibrs_offender_new.incident_id, nibrs_incident_new.agency_id, EXTRACT(YEAR FROM nibrs_incident_new.incident_date) as year, nibrs_incident_new.incident_date, nibrs_offender_new.offender_id, nibrs_offender_new.age_id, nibrs_offender_new.age_num::numeric, nibrs_offender_new.sex_code,nibrs_offender_new.race_id, nibrs_ethnicity.ethnicity_name from nibrs_offender_new  LEFT JOIN nibrs_incident_new on nibrs_incident_new.incident_id = nibrs_offender_new.incident_id  LEFT JOIN nibrs_ethnicity ON nibrs_ethnicity.ethnicity_id = nibrs_offender_new.ethnicity_id where nibrs_incident_new.incident_date >= to_timestamp('01-01-2000', 'MM-DD-YYYY');
UPDATE nibrs_offender_denorm_2000 SET state_id = ref_agency.state_id, county_id = ref_agency_county.county_id from ref_agency JOIN ref_agency_county ON ref_agency.agency_id = ref_agency_county.agency_id where nibrs_offender_denorm_2000.agency_id = ref_agency.agency_id and nibrs_offender_denorm_2000.year = '2000';
UPDATE nibrs_offender_denorm_2000 SET state_code = ref_state.state_code from ref_state where nibrs_offender_denorm_2000.state_id = ref_state.state_id and nibrs_offender_denorm_2000.year = '2000';
UPDATE nibrs_offender_denorm_2000 SET race_code = ref_race.race_code from ref_race where nibrs_offender_denorm_2000.race_id = ref_race.race_id and nibrs_offender_denorm_2000.year = '2000'; 
UPDATE nibrs_offender_denorm_2000 SET offense_type_id = nibrs_offense_new.offense_type_id, location_id = nibrs_offense_new.location_id from nibrs_offense_new where nibrs_offense_new.incident_id = nibrs_offender_denorm_2000.incident_id and nibrs_offender_denorm_2000.year = '2000';
UPDATE nibrs_offender_denorm_2000 SET offense_name = nibrs_offense_type.offense_name from nibrs_offense_type where nibrs_offense_type.offense_type_id = nibrs_offender_denorm_2000.offense_type_id and nibrs_offender_denorm_2000.year = '2000';
UPDATE nibrs_offender_denorm_2000 SET location_name = nibrs_location_type.location_name, location_code=nibrs_location_type.location_code from nibrs_location_type where nibrs_location_type.location_id = nibrs_offender_denorm_2000.location_id and nibrs_offender_denorm_2000.year = '2000';
UPDATE nibrs_offender_denorm_2000 SET property_id = nibrs_property_new.property_id, property_loss_id=nibrs_property_new.prop_loss_id from nibrs_property_new where nibrs_property_new.incident_id = nibrs_offender_denorm_2000.incident_id;
UPDATE nibrs_offender_denorm_2000 SET property_desc_id = nibrs_property_desc_new.prop_desc_id from nibrs_property_desc_new where nibrs_property_desc_new.property_id = nibrs_offender_denorm_2000.property_id;
UPDATE nibrs_offender_denorm_2000 SET offense_id = nibrs_offense_new.offense_id from nibrs_offense_new where nibrs_offender_denorm_2000.incident_id = nibrs_offense_new.incident_id and nibrs_offender_denorm_2000.year = '2000';
UPDATE nibrs_offender_denorm_2000 SET bias_id = nibrs_bias_motivation.bias_id from nibrs_bias_motivation where nibrs_bias_motivation.offense_id = nibrs_offender_denorm_2000.offense_id and nibrs_offender_denorm_2000.year = '2000';
UPDATE nibrs_offender_denorm_2000 SET bias_name = nibrs_bias_list.bias_name from nibrs_bias_list where nibrs_offender_denorm_2000.bias_id = nibrs_bias_list.bias_id and nibrs_offender_denorm_2000.year = '2000';

-- denorm offenses
INSERT INTO nibrs_offense_denorm_2000 (incident_id, agency_id, year, incident_date, offense_id, method_entry_code, num_premises_entered, location_id, offense_type_id, attempt_complete_flag) SELECT nibrs_offense_new.incident_id, nibrs_incident_new.agency_id, EXTRACT(YEAR FROM nibrs_incident_new.incident_date) as year, nibrs_incident_new.incident_date, nibrs_offense_new.offense_id, nibrs_offense_new.method_entry_code, nibrs_offense_new.num_premises_entered, nibrs_offense_new.location_id, nibrs_offense_new.offense_type_id, nibrs_offense_new.attempt_complete_flag from nibrs_offense_new  JOIN nibrs_incident_new on nibrs_incident_new.incident_id = nibrs_offense_new.incident_id where nibrs_incident_new.incident_date >= to_timestamp('01-01-2000', 'MM-DD-YYYY');
UPDATE nibrs_offense_denorm_2000 SET state_id = ref_agency.state_id, county_id = ref_agency_county.county_id from ref_agency JOIN ref_agency_county ON ref_agency.agency_id = ref_agency_county.agency_id where nibrs_offense_denorm_2000.agency_id = ref_agency.agency_id and nibrs_offense_denorm_2000.year = '2000';
UPDATE nibrs_offense_denorm_2000 SET state_code = ref_state.state_code from ref_state where nibrs_offense_denorm_2000.state_id = ref_state.state_id and nibrs_offense_denorm_2000.year = '2000';
UPDATE nibrs_offense_denorm_2000 SET location_name = nibrs_location_type.location_name, location_code=nibrs_location_type.location_code from nibrs_location_type where nibrs_location_type.location_id = nibrs_offense_denorm_2000.location_id and nibrs_offense_denorm_2000.year = '2000';
UPDATE nibrs_offense_denorm_2000 SET offense_name = nibrs_offense_type.offense_name from nibrs_offense_type where nibrs_offense_type.offense_type_id = nibrs_offense_denorm_2000.offense_type_id and nibrs_offense_denorm_2000.year = '2000';
UPDATE nibrs_offense_denorm_2000 SET weapon_id = nibrs_weapon.weapon_id from nibrs_weapon where nibrs_weapon.offense_id = nibrs_offense_denorm_2000.offense_id and nibrs_offense_denorm_2000.year = '2000';
UPDATE nibrs_offense_denorm_2000 SET weapon_name = nibrs_weapon_type.weapon_name from nibrs_weapon_type where nibrs_weapon_type.weapon_id = nibrs_offense_denorm_2000.weapon_id and nibrs_offense_denorm_2000.year = '2000';
UPDATE nibrs_offense_denorm_2000 SET bias_name = nibrs_bias_list.bias_name, suspected_using = nibrs_using_list.suspect_using_name from nibrs_bias_motivation JOIN nibrs_bias_list ON (nibrs_bias_motivation.bias_id = nibrs_bias_list.bias_id) JOIN nibrs_suspect_using ON (nibrs_suspect_using.offense_id =  nibrs_bias_motivation.offense_id) JOIN nibrs_using_list ON (nibrs_using_list.suspect_using_id = nibrs_suspect_using.suspect_using_id) where nibrs_offense_denorm_2000.offense_id = nibrs_bias_motivation.offense_id  and nibrs_offense_denorm_2000.year = '2000';


-- denorm arrestees 
INSERT INTO nibrs_arrestee_denorm_2000 (incident_id,arrest_type_id, agency_id, year, incident_date, arrestee_id, age_id, age_num, sex_code, race_id, arrest_date, resident_status, under_18_disposition_code, clearance_ind) SELECT nibrs_arrestee_new.incident_id, nibrs_arrestee_new.arrest_type_id, nibrs_incident_new.agency_id, EXTRACT(YEAR FROM nibrs_incident_new.incident_date) as year, nibrs_incident_new.incident_date, nibrs_arrestee_new.arrestee_id, nibrs_arrestee_new.age_id, nibrs_arrestee_new.age_num::numeric, nibrs_arrestee_new.sex_code,nibrs_arrestee_new.race_id, nibrs_arrestee_new.arrest_date, nibrs_arrestee_new.resident_code, nibrs_arrestee_new.under_18_disposition_code, nibrs_arrestee_new.clearance_ind from nibrs_arrestee_new JOIN nibrs_incident_new on nibrs_incident_new.incident_id = nibrs_arrestee_new.incident_id where nibrs_incident_new.incident_date >= to_timestamp('01-01-2000', 'MM-DD-YYYY');
UPDATE nibrs_arrestee_denorm_2000 SET race_code = ref_race.race_code from ref_race where nibrs_arrestee_denorm_2000.race_id = ref_race.race_id and nibrs_arrestee_denorm_2000.year = '2000'; 
UPDATE nibrs_arrestee_denorm_2000 SET arrest_type_name = nibrs_arrest_type.arrest_type_name from nibrs_arrest_type where nibrs_arrestee_denorm_2000.arrest_type_id = nibrs_arrest_type.arrest_type_id and nibrs_arrestee_denorm_2000.year = '2000';
UPDATE nibrs_arrestee_denorm_2000 SET arrest_type_code = nibrs_arrest_type.arrest_type_code, ethnicity = nibrs_ethnicity.ethnicity_name from nibrs_arrestee_new JOIN nibrs_arrest_type ON (nibrs_arrestee_new.arrest_type_id = nibrs_arrest_type.arrest_type_id) JOIN nibrs_ethnicity ON nibrs_ethnicity.ethnicity_id = nibrs_arrestee_new.ethnicity_id where nibrs_arrestee_denorm_2000.year = '2000';
UPDATE nibrs_arrestee_denorm_2000 SET arrest_type_code = nibrs_arrest_type.arrest_type_code, ethnicity = nibrs_ethnicity.ethnicity_name from nibrs_arrestee_new JOIN nibrs_arrest_type ON (nibrs_arrestee_new.arrest_type_id = nibrs_arrest_type.arrest_type_id) JOIN nibrs_ethnicity ON nibrs_ethnicity.ethnicity_id = nibrs_arrestee_new.ethnicity_id where nibrs_arrestee_denorm_2000.arrestee_id = nibrs_arrestee_new.arrestee_id and nibrs_arrestee_denorm_2000.year = '2000';

-- denorm property
INSERT INTO nibrs_property_denorm_2000 (incident_id, agency_id, year, incident_date, property_id, stolen_count) SELECT nibrs_incident_new.incident_id, nibrs_incident_new.agency_id, EXTRACT(YEAR FROM nibrs_incident_new.incident_date) as year, nibrs_incident_new.incident_date, nibrs_property_new.property_id, nibrs_property_new.stolen_count from nibrs_property_new JOIN nibrs_incident_new on nibrs_incident_new.incident_id = nibrs_property_new.incident_id and nibrs_incident_new.incident_date >= to_timestamp('01-01-2000', 'MM-DD-YYYY');
UPDATE nibrs_property_denorm_2000 SET state_id = ref_agency.state_id, ori = ref_agency.ori from ref_agency where nibrs_property_denorm_2000.agency_id = ref_agency.agency_id and nibrs_property_denorm_2000.year = '2000';
UPDATE nibrs_property_denorm_2000 SET state_code = ref_state.state_code from ref_state where nibrs_property_denorm_2000.state_id = ref_state.state_id and nibrs_property_denorm_2000.year = '2000';
UPDATE nibrs_property_denorm_2000 SET date_recovered = nibrs_property_desc_new.date_recovered, property_value = nibrs_property_desc_new.property_value, property_desc_id = nibrs_property_desc_new.prop_desc_id from nibrs_property_desc_new where nibrs_property_desc_new.property_id = nibrs_property_denorm_2000.property_id and nibrs_property_denorm_2000.year = '2000';
UPDATE nibrs_property_denorm_2000 SET prop_desc_name = nibrs_prop_desc_type.prop_desc_name from nibrs_prop_desc_type where nibrs_prop_desc_type.prop_desc_id = nibrs_property_denorm_2000.property_desc_id and nibrs_property_denorm_2000.year = '2000';
UPDATE nibrs_property_denorm_2000 SET est_drug_qty = nibrs_suspected_drug.est_drug_qty, drug_measure_code = nibrs_drug_measure_type.drug_measure_code, drug_measure_name = nibrs_drug_measure_type.drug_measure_name from nibrs_property_new JOIN nibrs_suspected_drug ON (nibrs_suspected_drug.property_id = nibrs_property_new.property_id) JOIN nibrs_drug_measure_type ON (nibrs_suspected_drug.drug_measure_type_id = nibrs_drug_measure_type.drug_measure_type_id) where nibrs_property_denorm_2000.property_id = nibrs_property_new.property_id and nibrs_property_denorm_2000.year = '2000';
...
BEGIN
   ...
   LOOP
    ...
    WHERE ar.reported IS TRUE and rm.data_year = 2000 
...
JOIN reta_offense_subcat ros ON a.offense_subcat_id = ros.offense_subcat_id
JOIN reta_offense ro ON ro.offense_id = ros.offense_id
WHERE a.offense_subcat_id IN (40, 41, 42, 43, 44) AND a.data_year = 2000 
GROUP by a.data_year, a.agency_id, ro.offense_id;
...
WHERE a.offense_subcat_id <> 45 AND a.data_year = 2000 
...
WHERE rep.months_reported = 12 AND am.data_year = 2000 
...
WHERE ar.months_reported = 12 AND ambs.actual_status = 0 AND am.data_year = 2000 
GROUP BY GROUPING SETS(
(year),
