...
CASE WHEN fnvw.automatic_firearm + fnvw.automatic_handgun + fnvw.automatic_rifle + fnvw.automatic_shotgun + fnvw.automatic_other_firearm + fnvw.firearm + fnvw.handgun + fnvw.rifle + fnvw.shotgun + fnvw.other_firearm > 0 THEN 1 ELSE 0 END as weapon_gun,
CASE WHEN fnvw.lethal_cutting + fnvw.knife > 0 THEN 1 ELSE 0 END as weapon_knife,
CASE WHEN fnvw.club + fnvw.blunt_object > 0 THEN 1 ELSE 0 END as weapon_blunt_object,
CASE WHEN fnvw.drugs + fnvw.poison > 0 THEN 1 ELSE 0 END as weapon_poison,
CASE WHEN fnvw.fire + fnvw.explosives > 0 THEN 1 ELSE 0 END as weapon_incendiary,
fnvw.motor_vehicle AS weapon_motor_vehicle,
CASE WHEN fnvw.personal_weapons + fnvw.other_weapon > 0 THEN 1 ELSE 0 END as weapon_other,
...
LEFT OUTER JOIN flat_nibrs_victim_weapons fnvw ON fnvw.victim_id = v.victim_id
