...
UPDATE public.summarized_data sd
 ...
 select agency_id , ori as ori, agency_type_name as agency_type_name, state_id as state_id, state_abbr as state_abbr, agency_name_edit as agency_name_edit, county_name as county_name
   ...
   (((SUM(sum_hom)*1.0)/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0) as homicide_rate,
   ...
   ((((SUM(sum_rpe_ns_leg)+SUM(sum_rpe_frc_leg)) *1.0)/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0) as rape_legacy_rate,
   ...
   ((((((SUM(sum_rpe_ns)+SUM(sum_rpe_frc)+SUM(sum_rpe_att))) *1.0))/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0) as rape_rate,
   ...
   (((((SUM(sum_rob_ns)+SUM(sum_rob_gun)+SUM(sum_rob_cut)+SUM(sum_rob_oth)+SUM(sum_rob_hff))) *1.0)/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0) as robbery_rate,
   ...
   (((((SUM(sum_ass_ns)+SUM(sum_ass_gun)+SUM(sum_ass_cut)+SUM(sum_ass_hff)+SUM(sum_hom)+SUM(sum_rpe_ns_leg)+SUM(sum_rpe_frc_leg)+SUM(sum_rpe_ns)+SUM(sum_rpe_frc)+SUM(sum_rpe_att)+SUM(sum_rob_ns)+SUM(sum_rob_gun)+SUM(sum_rob_cut)+SUM(sum_rob_oth)+SUM(sum_rob_hff))) *1.0)/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0) as violent_crime_rate,
   ...
   (SUM(sum_ass_ns)+SUM(sum_ass_gun)+SUM(sum_ass_cut)+SUM(sum_ass_hff)) as aggravated_assult,
   (((((SUM(sum_ass_ns)+SUM(sum_ass_gun)+SUM(sum_ass_cut)+SUM(sum_ass_hff))) *1.0)/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0) as aggravated_assult_rate,
   ...
   (((((SUM(sum_brg_ns)+SUM(sum_brg_feo)+SUM(sum_brg_ueo)+SUM(sum_brg_afe))) *1.0)/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0) as burglary_rate,
   ...
   (((((SUM(sum_mtr_ns)+SUM(sum_mtr_ato)+SUM(sum_mtr_trk)+SUM(sum_mtr_oth))) *1.0)/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0) as motor_vehicle_theft_rate,
   ...
   (((((SUM(sum_lar_tft)+SUM(sum_ars)+SUM(sum_brg_ns)+SUM(sum_brg_feo)+SUM(sum_brg_ueo)+SUM(sum_brg_afe)+SUM(sum_mtr_ns)+SUM(sum_mtr_ato)+SUM(sum_mtr_trk)+SUM(sum_mtr_oth))) *1.0)/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0) as property_crime_rate,
   ...
   (((((SUM(sum_ht_ns)+SUM(sum_ht_sex)+SUM(sum_ht_srv))) *1.0)/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0)as human_trafficing_rate,
   SUM(sum_ars) as arson,
   ((((SUM(sum_ars)) *1.0)/ (SUM(CASE WHEN month_num = 12 THEN population ELSE 0 END) )*1.0) * 100000.0) as arson_rate
