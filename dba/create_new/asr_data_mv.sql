...
CREATE MATERIALIZED VIEW public.asr_age_female_count_national AS
  ...
  CREATE MATERIALIZED VIEW public.asr_data_group_race_view AS
    select data_year, agency_id, 'Unknown' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_UNKNOWN_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'White' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_WHITE_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'Black' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_BLACK_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'Amian' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_AMIAN_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'Asian' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_ASIAN_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'Anhopi' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_ANHOPI_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'Chinese' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_CHINESE_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'Japanese' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_JAPANESE_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'Nhopi' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_NHOPI_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'Other' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_OTHER_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'Multiple' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_MULTIPLE_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME
  union all
    select data_year, agency_id, 'Not Specified' as race, OFFENSE_SUBCAT_NAME as offense_name,
    coalesce(sum(RACE_NOT_SPECIFIED_ARR_CNT),0) as cnt
    from asr_data
    group by data_year, agency_id, OFFENSE_SUBCAT_NAME

CREATE MATERIALIZED VIEW public.asr_race_count_agency AS
  select a.data_year, a.agency_id, agy.ori as ori, race,
  sum(CASE WHEN offense_name='Aggravated Assault' then cnt else 0 end) as Aggravated_Assault,
  sum(CASE WHEN offense_name='All Other Offenses (Except Traffic)' then cnt else 0 end) as All_Other_Offenses_Except_Traffic,
  sum(CASE WHEN offense_name='Arson' then cnt else 0 end) as Arson,
  sum(CASE WHEN offense_name='Burglary - Breaking or Entering' then cnt else 0 end) as Burglary_Breaking_or_Entering,
  ...
  sum(CASE WHEN offense_name='Weapons: Carrying, Possessing, Etc.' then cnt else 0 end) as Weapons_Carrying_Possessing_Etc,
  sum(CASE WHEN offense_name='Zero Report' then cnt else 0 end) as Zero_Report
  from asr_data_group_race_view a
  join agency_data agy on agy.agency_id=a.agency_id
  group by a.data_year, a.agency_id, ori, race
  order by a.data_year, ori, race

CREATE MATERIALIZED VIEW public.asr_race_count_state AS
  select a.data_year, agy.state_abbr as state_abbr, race,
  sum(CASE WHEN offense_name='Aggravated Assault' then cnt else 0 end) as Aggravated_Assault,
  sum(CASE WHEN offense_name='All Other Offenses (Except Traffic)' then cnt else 0 end) as All_Other_Offenses_Except_Traffic,
  sum(CASE WHEN offense_name='Arson' then cnt else 0 end) as Arson,
  sum(CASE WHEN offense_name='Burglary - Breaking or Entering' then cnt else 0 end) as Burglary_Breaking_or_Entering,
  ...
  from asr_data_group_race_view a
  join agency_data agy on agy.agency_id=a.agency_id
  group by a.data_year, state_abbr, race
  order by a.data_year, state_abbr, race

CREATE MATERIALIZED VIEW public.asr_race_count_region AS
  select a.data_year, agy.region_name as region_name, race,
  sum(CASE WHEN offense_name='Aggravated Assault' then cnt else 0 end) as Aggravated_Assault,
  sum(CASE WHEN offense_name='All Other Offenses (Except Traffic)' then cnt else 0 end) as All_Other_Offenses_Except_Traffic,
  sum(CASE WHEN offense_name='Arson' then cnt else 0 end) as Arson,
  sum(CASE WHEN offense_name='Burglary - Breaking or Entering' then cnt else 0 end) as Burglary_Breaking_or_Entering,
  ...
  from asr_data_group_race_view a
  join agency_data agy on agy.agency_id=a.agency_id
  group by a.data_year, region_name, race
  order by a.data_year, region_name, race

CREATE MATERIALIZED VIEW public.asr_race_count_national AS
  select data_year, race,
  sum(CASE WHEN offense_name='Aggravated Assault' then cnt else 0 end) as Aggravated_Assault,
  sum(CASE WHEN offense_name='All Other Offenses (Except Traffic)' then cnt else 0 end) as All_Other_Offenses_Except_Traffic,
  sum(CASE WHEN offense_name='Arson' then cnt else 0 end) as Arson,
  sum(CASE WHEN offense_name='Burglary - Breaking or Entering' then cnt else 0 end) as Burglary_Breaking_or_Entering,
  ...
  sum(CASE WHEN offense_name='Weapons: Carrying, Possessing, Etc.' then cnt else 0 end) as Weapons_Carrying_Possessing_Etc,
  sum(CASE WHEN offense_name='Zero Report' then cnt else 0 end) as Zero_Report
  from asr_data_group_race_view
  group by data_year, race
  order by data_year, race

CREATE MATERIALIZED VIEW public.asr_data_group_race_youth_view AS
  select data_year, agency_id, 'Unknown' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_UNKNOWN_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'White' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_WHITE_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'Black' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_BLACK_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'Amian' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_AMIAN_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'Asian' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_ASIAN_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'Anhopi' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_ANHOPI_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'Chinese' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_CHINESE_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'Japanese' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_JAPANESE_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'Nhopi' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_NHOPI_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'Other' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_OTHER_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'Multiple' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_MULTIPLE_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME
union all
  select data_year, agency_id, 'Not Specified' as race, OFFENSE_SUBCAT_NAME as offense_name,
  coalesce(sum(RACE_NOT_SPECIFIED_YTH_ARR_CNT),0) as cnt
  from asr_data
  group by data_year, agency_id, OFFENSE_SUBCAT_NAME

CREATE MATERIALIZED VIEW public.asr_race_youth_count_agency AS
  select a.data_year, a.agency_id, agy.ori as ori, race,
  sum(CASE WHEN offense_name='Aggravated Assault' then cnt else 0 end) as Aggravated_Assault,
  sum(CASE WHEN offense_name='All Other Offenses (Except Traffic)' then cnt else 0 end) as All_Other_Offenses_Except_Traffic,
  sum(CASE WHEN offense_name='Arson' then cnt else 0 end) as Arson,
  ...
  sum(CASE WHEN offense_name='Weapons: Carrying, Possessing, Etc.' then cnt else 0 end) as Weapons_Carrying_Possessing_Etc,
  sum(CASE WHEN offense_name='Zero Report' then cnt else 0 end) as Zero_Report
  from asr_data_group_race_youth_view a
  join agency_data agy on agy.agency_id=a.agency_id
  group by a.data_year, a.agency_id, ori, race
  order by a.data_year, ori, race

CREATE MATERIALIZED VIEW public.asr_race_youth_count_state AS
  select a.data_year, agy.state_abbr as state_abbr, race,
  sum(CASE WHEN offense_name='Aggravated Assault' then cnt else 0 end) as Aggravated_Assault,
  sum(CASE WHEN offense_name='All Other Offenses (Except Traffic)' then cnt else 0 end) as All_Other_Offenses_Except_Traffic,
  sum(CASE WHEN offense_name='Arson' then cnt else 0 end) as Arson,
...
CREATE MATERIALIZED VIEW public.asr_race_youth_count_region AS
  select a.data_year, agy.region_name as region_name, race,
  sum(CASE WHEN offense_name='Aggravated Assault' then cnt else 0 end) as Aggravated_Assault,
  sum(CASE WHEN offense_name='All Other Offenses (Except Traffic)' then cnt else 0 end) as All_Other_Offenses_Except_Traffic,
  sum(CASE WHEN offense_name='Arson' then cnt else 0 end) as Arson,
...
CREATE MATERIALIZED VIEW public.asr_race_youth_count_national AS
  select data_year, race,
  sum(CASE WHEN offense_name='Aggravated Assault' then cnt else 0 end) as Aggravated_Assault,
  sum(CASE WHEN offense_name='All Other Offenses (Except Traffic)' then cnt else 0 end) as All_Other_Offenses_Except_Traffic,
  sum(CASE WHEN offense_name='Arson' then cnt else 0 end) as Arson,
  ...
  sum(CASE WHEN offense_name='Weapons: Carrying, Possessing, Etc.' then cnt else 0 end) as Weapons_Carrying_Possessing_Etc,
  sum(CASE WHEN offense_name='Zero Report' then cnt else 0 end) as Zero_Report
  from asr_data_group_race_youth_view
  group by data_year, race
  order by data_year, race
