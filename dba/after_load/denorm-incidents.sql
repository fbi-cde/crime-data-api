...
UPDATE nibrs_incident_denorm SET state_abbr = ref_state.state_postal_abbr from ref_state where nibrs_incident_denorm.state_id = ref_state.state_id;

CREATE INDEX nibrs_incident_denorm_state_year_id_idx ON nibrs_incident_denorm (state_abbr, year);
