...
create materialized view offense_offender_counts as 
    SELECT * FROM offense_offender_counts_2014 UNION 
    SELECT * FROM offense_offender_counts_2013 UNION
    SELECT * FROM offense_offender_counts_2012 UNION 
    SELECT * FROM offense_offender_counts_2011 UNION 
    SELECT * FROM offense_offender_counts_2010 UNION
    SELECT * FROM offense_offender_counts_2009 UNION 
    SELECT * FROM offense_offender_counts_2008 UNION 
    SELECT * FROM offense_offender_counts_2007 UNION
    SELECT * FROM offense_offender_counts_2006 UNION 
    SELECT * FROM offense_offender_counts_2005 UNION 
    SELECT * FROM offense_offender_counts_2004 UNION
    SELECT * FROM offense_offender_counts_2003 UNION 
    SELECT * FROM offense_offender_counts_2002 UNION 
    SELECT * FROM offense_offender_counts_2001 UNION
    SELECT * FROM offense_offender_counts_2000 UNION 
    SELECT * FROM offense_offender_counts_1999 UNION 
    SELECT * FROM offense_offender_counts_1998 UNION
    SELECT * FROM offense_offender_counts_1997 UNION 
    SELECT * FROM offense_offender_counts_1996 UNION 
    SELECT * FROM offense_offender_counts_1995 UNION
    SELECT * FROM offense_offender_counts_1994 UNION 
    SELECT * FROM offense_offender_counts_1993 UNION 
    SELECT * FROM offense_offender_counts_1992 UNION
    SELECT * FROM offense_offender_counts_1991;
