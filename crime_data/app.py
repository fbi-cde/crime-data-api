...
def add_resources(app):
    ...
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyVictimDenormCount,'/nibrs/victim/count/<string:crime>/agencies/<string:ori>')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyVictimDenormSex,'/nibrs/victim/count/<string:crime>/agencies/<string:ori>/sex')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyVictimDenormAge,'/nibrs/victim/count/<string:crime>/agencies/<string:ori>/age')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyVictimDenormRace,'/nibrs/victim/count/<string:crime>/agencies/<string:ori>/race')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyVictimDenormEthnicity,'/nibrs/victim/<string:crime>/count/agencies/<string:ori>/ethnicity')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyVictimDenormLocation,'/nibrs/victim/<string:crime>/count/agencies/<string:ori>/location')

    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyOffenderDenormCount,'/nibrs/offender/count/<string:crime>/agencies/<string:ori>')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyOffenderDenormSex,'/nibrs/offender/count/<string:crime>/agencies/<string:ori>/sex')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyOffenderDenormAge,'/nibrs/offender/count/<string:crime>/agencies/<string:ori>/age')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyOffenderDenormRace,'/nibrs/offender/count/<string:crime>/agencies/<string:ori>/race')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyOffenderDenormEthnicity,'/nibrs/offender/count/<string:crime>/agencies/<string:ori>/ethnicity')

    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateVictimDenormCount,'/nibrs/victim/count/<string:crime>/states/<string:state_abbr>')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateVictimDenormSex,'/nibrs/victim/count/<string:crime>/states/<string:state_abbr>/sex')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateVictimDenormAge,'/nibrs/victim/count/<string:crime>/states/<string:state_abbr>/age')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateVictimDenormRace,'/nibrs/victim/count/<string:crime>/states/<string:state_abbr>/race')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateVictimDenormEthnicity,'/nibrs/victim/count/<string:crime>/states/<string:state_abbr>/ethnicity')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateVictimDenormLocation,'/nibrs/victim/count/<string:crime>/states/<string:state_abbr>/location')

    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateOffenderDenormCount,'/nibrs/offender/count/<string:crime>/states/<string:state_abbr>')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateOffenderDenormSex,'/nibrs/offender/count/<string:crime>/states/<string:state_abbr>/sex')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateOffenderDenormAge,'/nibrs/offender/count/<string:crime>/states/<string:state_abbr>/age')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateOffenderDenormRace,'/nibrs/offender/count/<string:crime>/states/<string:state_abbr>/race')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateOffenderDenormEthnicity,'/nibrs/offender/count/<string:crime>/states/<string:state_abbr>/ethnicity')

    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalVictimDenormCount,'/nibrs/victim/count/<string:crime>/national')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalVictimDenormSex,'/nibrs/victim/count/<string:crime>/national/sex')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalVictimDenormAge,'/nibrs/victim/count/<string:crime>/national/age')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalVictimDenormRace,'/nibrs/victim/count/<string:crime>/national/race')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalVictimDenormEthnicity,'/nibrs/victim/count/<string:crime>/national/ethnicity')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalVictimDenormLocation,'/nibrs/victim/count/<string:crime>/national/location')

    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalOffenderDenormCount,'/nibrs/offender/count/<string:crime>/national')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalOffenderDenormSex,'/nibrs/offender/count/<string:crime>/national/sex')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalOffenderDenormAge,'/nibrs/offender/count/<string:crime>/national/age')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalOffenderDenormRace,'/nibrs/offender/count/<string:crime>/national/race')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalOffenderDenormEthnicity,'/nibrs/offender/count/<string:crime>/national/ethnicity')

    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateDenormVictimOffenderRelationship,'/nibrs/victim/count/<string:crime>/states/<string:state_abbr>/relationships')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyDenormVictimOffenderRelationship,'/nibrs/victim/count/<string:crime>/agencies/<string:ori>/relationships')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalDenormVictimOffenderRelationship,'/nibrs/victim/count/<string:crime>/national/relationships')

    api.add_resource(crime_data.resources.nibrs_counts.NIBRSStateOffenseCount,'/nibrs/offense/count/<string:crime>/states/<string:state_abbr>')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSAgencyOffenseCount,'/nibrs/offense/count/<string:crime>/agencies/<string:ori>')
    api.add_resource(crime_data.resources.nibrs_counts.NIBRSNationalOffenseCount,'/nibrs/offense/count/<string:crime>/national')
