...
class CachedIncidentCountSchema(Schema):
    ...
    data_year = marsh_fields.Integer(load_only=True)
    month_num = marsh_fields.Integer(load_only=True)
    offense_subcat_name = marsh_fields.String(load_only=True)
    offense_subcat_code = marsh_fields.String(load_only=True)
    offense_name = marsh_fields.String(load_only=True)
    offense_code = marsh_fields.String(load_only=True)
    offense_category_name = marsh_fields.String(load_only=True)
    classification_name = marsh_fields.String(load_only=True)
    ori = marsh_fields.String(load_only=True)
    ucr_agency_name = marsh_fields.String(load_only=True)
    ncic_agency_name = marsh_fields.String(load_only=True)
    city_name = marsh_fields.String(load_only=True)
    state_name = marsh_fields.String(load_only=True)
    state_abbr = marsh_fields.String(load_only=True)
    population_family_name = marsh_fields.String(load_only=True)
    population_family_desc = marsh_fields.String(load_only=True)
