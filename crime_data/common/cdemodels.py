...
class ASRRaceCountAgency(db.Model):
    """Represents Agency Level ASR data for race"""
    __tablename__ = 'asr_race_count_agency'
    __table_args__ = (
        PrimaryKeyConstraint('race', 'data_year','agency_id'),
    )

    def get(ori=None):
        query = ASRRaceCountAgency.query

        if ori:
            query = query.filter(func.lower(ASRRaceCountAgency.ori) == func.lower(ori))
...
class ASRRaceCountState(db.Model):
    """Represents State Level ASR data for race"""
    __tablename__ = 'asr_race_count_state'
    __table_args__ = (
        PrimaryKeyConstraint('race','data_year','state_abbr'),
    )

    def get(state_abbr=None):
        query = ASRRaceCountState.query

        if state_abbr:
            query = query.filter(func.lower(ASRRaceCountState.state_abbr) == func.lower(state_abbr))
...
class ASRRaceCountRegion(db.Model):
    """Represents Region Level ASR data for race"""
    __tablename__ = 'asr_race_count_region'
    __table_args__ = (
        PrimaryKeyConstraint('race','data_year','region_name'),
    )

    def get(region_name=None):
        query = ASRRaceCountRegion.query

        if region_name:
            query = query.filter(func.lower(ASRRaceCountRegion.region_name) == func.lower(region_name))
...
class ASRRaceCountNational(db.Model):
    """Represents National Level ASR data by race"""
    __tablename__ = 'asr_race_count_national'
    __table_args__ = (
        PrimaryKeyConstraint('race','data_year'),
    )
...
class ASRRaceYouthCountAgency(db.Model):
    """Represents Agency Level ASR data for race youth"""
    __tablename__ = 'asr_race_youth_count_agency'
    __table_args__ = (
        PrimaryKeyConstraint('race', 'data_year','agency_id'),
    )

    def get(ori=None):
        query = ASRRaceYouthCountAgency.query

        if ori:
            query = query.filter(func.lower(ASRRaceYouthCountAgency.ori) == func.lower(ori))
...
class ASRRaceYouthCountState(db.Model):
    """Represents State Level ASR data for race youth"""
    __tablename__ = 'asr_race_youth_count_state'
    __table_args__ = (
        PrimaryKeyConstraint('race','data_year','state_abbr'),
    )

    def get(state_abbr=None):
        query = ASRRaceYouthCountState.query

        if state_abbr:
            query = query.filter(func.lower(ASRRaceYouthCountState.state_abbr) == func.lower(state_abbr))
...
class ASRRaceYouthCountRegion(db.Model):
    """Represents Region Level ASR data for race youth"""
    __tablename__ = 'asr_race_youth_count_region'
    __table_args__ = (
        PrimaryKeyConstraint('race','data_year','region_name'),
    )

    def get(region_name=None):
        query = ASRRaceYouthCountRegion.query

        if region_name:
            query = query.filter(func.lower(ASRRaceYouthCountRegion.region_name) == func.lower(region_name))
...
class ASRRaceYouthCountNational(db.Model):
    """Represents National Level ASR data by race youth"""
    __tablename__ = 'asr_race_youth_count_national'
    __table_args__ = (
        PrimaryKeyConstraint('race','data_year'),
    )
