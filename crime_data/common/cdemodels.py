...
class SummarizedDataRegion(db.Model):
    ...
    robbery_rate = db.Column(db.Float)
    ...
    aggravated_assult = db.Column(db.Integer)
    aggravated_assult_rate = db.Column(db.Float)
    ...
    burglary_rate = db.Column(db.Float)
    larceny	= db.Column(db.Integer)
    larceny_rate	= db.Column(db.Float)
    ...
    motor_vehicle_theft_rate = db.Column(db.Float)
    sum_ht_ns = db.Column(db.Integer)
    sum_ht_sex = db.Column(db.Integer)
    sum_ht_srv = db.Column(db.Integer)
    human_trafficing = db.Column(db.Integer)
    human_trafficing_rate = db.Column(db.Float)
    arson	= db.Column(db.Integer)
    arson_rate = db.Column(db.Float)
...
class SummarizedDataAgency(db.Model):
    ...
    def get(state_abbr=None, ori=None):
        ...
        if state_abbr and ori:
            query = query.filter(func.lower(SummarizedDataAgency.state_abbr) == func.lower(state_abbr))
