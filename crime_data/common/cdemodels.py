...
class ASRMaleByAgeCountAgency(db.Model):
    ...
    offense_name = db.Column(db.String)
    age_0_to_9 = db.Column(db.Integer)
    age_10_to_19 = db.Column(db.Integer)
    age_20_to_29 = db.Column(db.Integer)
    age_30_to_39 = db.Column(db.Integer)
    age_40_to_49 = db.Column(db.Integer)
    age_50_to_59 = db.Column(db.Integer)
    age_over_60 = db.Column(db.Integer)
