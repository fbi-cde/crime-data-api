    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ht_month', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='ht.HtMonth')),
                ('offense_subcat', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='reta.RetaOffenseSubcat')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='htmonthoffensesubcat',
            unique_together=set([('offense_subcat', 'ht_month')]),
        ),
        migrations.AlterUniqueTogether(
            name='htmonth',
